		...
		<div class="grid-2">
			<div class="column-content markup-holder">
				...
				<h2 class="nav-tab-wrapper">
					<a href="#" class="nav-tab" <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>>Tab #01</a>
					<a href="#" class="nav-tab" <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>>Tab #02</a>
					<a href="#" class="nav-tab" <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>>Tab #03</a>
				</h2>
