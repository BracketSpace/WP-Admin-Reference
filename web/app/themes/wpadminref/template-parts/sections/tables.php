				...
				<table class="form-table">
					<tbody>
						<tr>
							...
							<td><input name="blogname" type="text" id="blogname" value="Your beautyful site title" class="regular-text"></td>
						</tr>
						<tr>
							<th scope="row"><label for="blogdescription">Tagline</label></th>
							<td>
								<input name="blogdescription" type="text" id="blogdescription" aria-describedby="tagline-description" value="Not just another WordPress site" class="regular-text">
						...
						<tr>
							...
							<td>
								<input name="siteurl" type="url" id="siteurl" value="https://wpadmin.bracketspace" disabled="disabled" class="regular-text code disabled">
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="home">Site Address (URL)</label></th>
							<td>
								<input name="home" type="url" id="home" aria-describedby="home-description" value="https://wpadmin.bracketspace" disabled="disabled" class="regular-text code disabled">
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="new_admin_email">Email Address</label></th>
							<td>
								<input name="new_admin_email" type="email" id="new_admin_email" aria-describedby="new-admin-email-description" value="dummy@domain.com" class="regular-text ltr">
								<p class="description" id="new-admin-email-description">
									...
									<strong>The new address will not become active until confirmed.</strong>
								</p>
							</td>
						</tr>
						<tr>
					...
					<th scope="row"><label for="timezone_string">Timezone</label></th>
						<td>
							...
							<p class="timezone-info">
								<span id="utc-time">Universal time (<abbr>UTC</abbr>) is <code>2019-08-12 12:36:17</code>.</span>
							</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<label>
									<input type="radio" name="date_format" value="F j, Y" checked="checked"> <span class="date-time-text format-i18n">August 12, 2019</span><code>F j, Y</code>
								</label><br>
								<label>
									<input type="radio" name="date_format" value="Y-m-d"> <span class="date-time-text format-i18n">2019-08-12</span><code>Y-m-d</code>
								</label>
								<br>
								<label>
									<input type="radio" name="date_format" value="m/d/Y"> 
									<span class="date-time-text format-i18n">08/12/2019</span><code>m/d/Y</code>
								</label>
								<br>
								<label>
									<input type="radio" name="date_format" value="d/m/Y"> 
									<span class="date-time-text format-i18n">12/08/2019</span>
									<code>d/m/Y</code>
								</label>
								<br>
								<label>
									<input type="radio" name="date_format" id="date_format_custom_radio" value="\c\u\s\t\o\m"> 
									<span class="date-time-text date-time-custom-text">Custom:
										<span class="screen-reader-text"> enter a custom date format in the following field</span></span>
								</label>
								<label for="date_format_custom" class="screen-reader-text">Custom date format:</label>
									...
									<br>
									<p>
										<strong>Preview:</strong> <span class="example">August 12, 2019</span><span class="spinner"></span>
									</p>
								</fieldset>
							</td>
						</tr>
							...
							<td>
								<fieldset>
									...
									<label>
										...
										<span class="date-time-text format-i18n">12:36 pm</span>
										<code>g:i a</code>
									</label>
									<br>
									<label>
									...
									<label>
										...
										<span class="date-time-text format-i18n">12:36</span>
										<code>H:i</code>
									</label>
									<br>
									<label>
										...
										<span class="date-time-text date-time-custom-text">Custom:
											<span class="screen-reader-text"> enter a custom time format in the following field</span>
										</span>
									</label>
									...
									<p>
										...
										<span class="example">12:36 pm</span>
